...
import static chatapp.Webcam2.Filename;
    ...
    private void CaptureImage(JLabel image) {
        try {
            ...
            if (getImage != null) {
                ...
                ImageIcon imageico = new ImageIcon(new ImageIcon(Filename).getImage().getScaledInstance(UpdateDetails2.jLabel12.getWidth(), UpdateDetails2.jLabel12.getHeight(), Image.SCALE_DEFAULT));
                UpdateDetails2.jLabel12.setIcon(imageico);
            }
        } catch (Exception e) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (option == 0) {
            try {
                ...
                UpdateDetails2.jTextField6.setText(Filename);
                ...
                UpdateDetails2.photo = baos.toByteArray();
                dispose();
            } catch (Exception e) {
                stopCam();
                JOptionPane.showMessageDialog(rootPane, "Warning");
